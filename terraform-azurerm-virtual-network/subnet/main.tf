...
resource "azurerm_network_security_group" "this" {
  ...
  name = (
    var.security_group_prefix != null
    ? "${var.security_group_prefix}-${var.subnet_name}-nsg"
    : "${var.subnet_name}-nsg"
  )
